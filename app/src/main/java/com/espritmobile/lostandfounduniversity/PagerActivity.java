...
import com.espritmobile.lostandfounduniversity.Utils.Utils;
...
public class PagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean isFirstTime = preferences.getBoolean("firstTime",false);

        if(isFirstTime){
            Intent introIntent = new Intent(PagerActivity.this, LoginActivity.class);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        int[] bgs = new int[]{R.drawable.ic_person_pin_circle_black_24dp, R.drawable.ic_lost_items, R.drawable.ic_delivery_worker_giving_a_box_to_a_receiver};
